...
from .views import GetProductReviewsView, GetProductReviewView, \
                    CreateProductReviewView, UpdateProductReviewView, \
                    DeleteProductReviewView, FilterProductReviewView
...
urlpatterns = [
    ...
    path('filter-reviews/<productId>', FilterProductReviewView.as_view()),
