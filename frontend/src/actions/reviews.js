...
export const get_review = product_id => async dispatch => {
    if (localStorage.getItem('access')) {
        ...
        try {
            const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/reviews/get-review/${product_id}`,
                config)
...
export const create_review = (product_id, rating, comment) => async dispatch => {
    if (localStorage.getItem('access')) {
        ...
        try {
            const res = await axios.post(`${process.env.REACT_APP_API_URL}/api/reviews/create-review/${product_id}`,
                body,
                config);
...
export const update_review = (product_id, rating, comment) => async dispatch => {
    if (localStorage.getItem('access')) {
        ...
        try {
            const res = await axios.put(`${process.env.REACT_APP_API_URL}/api/reviews/update-review/${product_id}`,
                body,
                config
            );
...
export const filter_review = (product_id, rating) => async dispatch => {
    if (localStorage.getItem('access')) {
        ...
        try {
            const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/reviews/filter-reviews/${product_id}?rating=${rating}`,
                config
            );
