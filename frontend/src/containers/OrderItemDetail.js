...
const OrderItemDetail = ({
    ...
    return (
        <div className='container mt-3'>
            <Helmet>
                <meta charSet="utf-8" />
                <meta name="description" content="OrderItemDetail Helmet application" />
                <title>E-Shop | OrderItemDetail</title>
                            ...
                            <ul className='list-group mb-3'>
                                <div>
                                    ...
                                    <ul className='list-group mb-3'>
                                        ...
                                        <li className='list-group-item'>
                                            State/Province: {order.state_province_region}
                                        </li>
                                        <li className='list-group-item'>
                                            Postal/Zip Code: {order.postal_zip_code}
                                        </li>
                                        <li className='list-group-item'>
                                            Country: {order.country_region}
                                        </li>
                                    </ul>
                                ...
                                <ul className='list-group mb-3'>
                                    ...
                                    <li className='list-group-item'>
                                        Contact Number: {order.telephone_number}
                                    </li>
                                    <li className='list-group-item'>
                                        Order date: {moment(order.date_issued).fromNow()}
                                    </li>
                                </ul>
